...
class Pixels:
    ...
    def __init__(self,
        ...
        if has_cuda:
            ...
            self.c = cp.zeros(shape=shape, dtype=cp.complex)
            self.z = cp.zeros(shape=shape, dtype=cp.complex)
        else:
            ...
            self.c = np.zeros(shape=shape, dtype=np.complex)
            self.z = np.zeros(shape=shape, dtype=np.complex)
